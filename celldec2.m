...
%for videos=91:91
z=0;
VidObj = VideoReader(strcat('D:\Work\IISc Part II\New folder\Assassin Creed III\video0008 15-10-20 18-06-12','.avi'));
...
% 42
 %RE = 280; % end value of the row
  RS = 600% start value of the row
   RE = 790;% start value of the row 70 734 74 266
